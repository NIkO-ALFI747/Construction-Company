<div class="row">
      ...
      <div id="forms_1">
        <div class="div_filter">
          <div id="div_filter">
            <form id="filter_form">
              <h5>Фильтры</h5>
              <span class="head">Типы объектов</span><br />
              <div id="div_select_object_types"></div>
              <span class="head">Города</span>
              <div id="div_select_object_cities"></div>
  ...
  <div class="col-md-8 col-sm-8">
    <div class="container my-card2" style="color:rgb(0, 0, 0);">
      <h4>Информация об объектах строительства</h4><br />
...
$("#div_filter").on("change", "select", function() {
  ...
  $.ajax( {
    ...
    data: {
      ...
      object_city: $("#select_object_cities option:selected").text(),
    },
    dataType: 'json'
  })
