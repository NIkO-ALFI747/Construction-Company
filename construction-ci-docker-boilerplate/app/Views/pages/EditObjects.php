<div id="card-container" class="container my-card2" style="color:rgb(0, 0, 0);">
  <div class="row mt-4">
    <h4 style="margin-bottom: 50px;">Изменение/Удаление объектов</h4><br />
    <div id="status"></div>
...
var editData = function(ID){
  ...
  .done(function (data, textStatus, jqXHR) { 
    ...
    <form id="object_edit">
      ...
      <h4 class="mt-4">Изменить объект</h4><br />
      <div class="container">
        <div class="row mt-4">
        ...
        <div class="row mt-4">
          ...
          <div class="col-sm">
            <div id="div_select_object_types">`
            + select +
            `</div>
          </div>
          <div class="col-sm"></div>
        ...
        <!--<div class="row mt-4">
          <div class="col-sm"></div>
          <div class="col-sm"><h5>Стоимость услуг:</h5></div>
          <div class="col-sm">
